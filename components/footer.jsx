...
export default function Footer() {
  return (
    <footer className="flex w-full justify-between items-start bg-emrg-black p-24 text-white">
      <div
        style={{ flexBasis: "25%" }}
        className="flex flex-col justify-between min-h-full items-stretch"
      >
      ...
      <div
        className="flex justify-around items-start max-w-xl"
        style={{ flexBasis: "50%" }}
      >
