export default function Testimonial() {
  return (
    <section className="text-white bg-emrg-black py-20 relative overflow-hidden">
      <div className="text-center mx-auto max-w-screen-xl">
        ...
        <blockquote className="max-w-4xl mx-auto font-sans italic  leading-loose text-xl p-8">
          ...
          repeatable and we’re seeing great results from the successful
          Salesforce adoption amongst our sales team.”
        </blockquote>
