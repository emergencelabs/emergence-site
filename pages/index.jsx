  ...
  return (
    <>
      ...
      <section>
        ...
        <section className="px-12 my-6 py-6  mx-auto">
          <div className="flex justify-between">
            <div className="flex-col" style={{ flexBasis: "30%" }}>
              <img
        ...
        <section className="px-12 relative">
          <PageSection title="Our Products">
            <a href="#">
              <div className="my-6 flex justify-around items-start border border-gray-300 bg-white rounded-lg p-4 hover:shadow-md duration-500 ease-in-out transition-shadow">
                <img
                  src="/assets/rle.svg"
